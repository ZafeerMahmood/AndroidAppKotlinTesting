...
import com.example.pose_detection_tensorflow_light.ml.LiteModelMovenetSingleposeLightningTfliteFloat164
...
class MainActivity : Activity() {
    ...
    val poseConnections = arrayOf(
        intArrayOf(0, 1),  // Connect point 0 to point 1
        intArrayOf(1, 2),  // Connect point 1 to point 2
        // ... Define more connections as needed for your pose model
    )
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        val buttonClick = findViewById<Button>(R.id.buttonGoToNextActivity)
        ...
        textureView.surfaceTextureListener = object:TextureView.SurfaceTextureListener{
            ...
            override fun onSurfaceTextureUpdated(p0: SurfaceTexture) {
                ...
                // Connect and draw lines between the pose points
                for (connection in poseConnections) {
                    val startX = outputFeature0[connection[0] * 3 + 1] * w
                    val startY = outputFeature0[connection[0] * 3] * h
                    val endX = outputFeature0[connection[1] * 3 + 1] * w
                    val endY = outputFeature0[connection[1] * 3] * h
